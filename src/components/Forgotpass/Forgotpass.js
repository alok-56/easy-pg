        ...
        <div>
            {
                data ?
                    <div id="sign_head">
                        {
                            load ? <span
                                style={{ marginTop: "440px", backgroundColor: "red", textAlign: "center" }}
                            >Incorrect otp</span> : null
                        }
                                ...
                                <div className="col " style={{ marginTop: "150px" }}>
                                    <div id="form">
                                        ...
                                        <div id="info">
                                            ...
                                            <button className="btn btn-primary mt-3 w-100" style={{ color: "#fff", fontWeight: "bold", textDecoration: "none" }} onClick={verify}>Verfiy</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="col " style={{ marginTop: "190px" }}>
                                        <div id="form1">
                                            ...
                                            <div id="info1">
                                                ...
                                                <button className="btn btn-primary mt-3 w-100" onClick={fun} style={{ textDecoration: "none", color: "#fff" }}>
                                                    {
