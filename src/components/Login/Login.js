        ...
        <div>
            <ToastContainer />
            {
                spin ?
                                ...
                                <div className="col-12" style={{ marginTop: "120px" }}>
                                    <div id="form2">
                                        ...
                                        <div id="info2">
                                            ...
                                            <button className="btn btn-primary mt-3 w-100" onClick={signin}>
                                                {
                    ...
                    :
                    <div
                        style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "300px" }}
                    ><SpinnerCircularFixed size={50} thickness={200} speed={133} color="rgba(172, 57, 59, 1)" secondaryColor="rgba(57, 172, 102, 1)" /></div>
            }
        </div>
    )
}
