...
const Ownerinfo = () => {
  ...
  const Owenerinfo = async () => {
    let data = await fetch(
      `https://easy-ser.vercel.app/roombooking/bookinglist/${params.id}`
    );
              ...
              <div id="payment_head1">
                ...
                <div id="detail1" className="mt-3">
                  ...
                  >
                    ...
                    <span style={{ fontWeight: "bold" }}>{ownerNumber}</span>
                  </div>
                  <div
                    className=" d-flex justify-content-between"
                    style={{ fontSize: "12px" }}
                ...
                <div>
                  <ul className="mt-3">
                    <li style={{ fontSize: "12px", fontWeight: "bold" }}>
                      Show any id proof during the time of Checkin
                    </li>
                    <li style={{ fontSize: "11px", fontWeight: "bold" }}>
                      100% refund if you cancel booking within 24 hour
                    </li>
                  </ul>
                </div>
              </div>
